...
import getResults from './get-results.util';

describe('getResults', () => {
  it('computes and sorts results correctly', () => {
    const nominations: Nominations = {
      '01': { userID: 'user1', text: 'nomination1' },
      '02': { userID: 'user2', text: 'nomination2' },
      '03': { userID: 'user3', text: 'nomination3' },
      '04': { userID: 'user4', text: 'nomination4' },
    };
